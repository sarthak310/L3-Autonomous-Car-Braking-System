...
public class MainActivity extends AppCompatActivity implements SensorEventListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        distanceTimeButton = (Button)findViewById(R.id.distanceTimeButton);
        distanceTimeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openDistanceTimeActivity();
            }
        });
    ...
    public void openDistanceTimeActivity() {
